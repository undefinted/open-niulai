...
The optional dependency set pins NumPy below 2 because common Windows SciPy and scikit-learn wheels used indirectly by Transformers can otherwise fail during pipeline import when mixed with NumPy 2.x binaries.
